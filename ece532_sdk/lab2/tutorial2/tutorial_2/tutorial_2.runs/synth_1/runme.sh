...
HD_PWD='/nfs/ug/homes-0/s/smithqu1/GitHub/research2018/ece532_sdk/lab2/tutorial2/tutorial_2/tutorial_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_tutorial_2_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_tutorial_2_wrapper.tcl
